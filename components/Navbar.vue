			...
			<div class="modal-box relative">
				...
				<div class="card-body">
					<div class="form-control">
						...
						<input type="text" placeholder="email" class="input input-bordered" v-model.lazy.trim="email" />
					</div>
					<div class="form-control">
						<label class="label">
							<span class="label-text">Password</span>
						</label>
						<input type="password" placeholder="password" class="input input-bordered" v-model.lazy.trim="password" />
